...
lj=lm(Long.jump~.,data=decathlon2.active)
summary(lj)
plot(decathlon2.active$Long.jump,decathlon2.active$X100m)

Jv=lm(Javeline~.,data=decathlon2.active)
summary(Jv)
plot(decathlon2.active$Javeline,decathlon2.active$X110m.hurdle)

lj=lm(X100m~.,data=decathlon2.active)
summary(lj)
plot(decathlon2.active$X100m,decathlon2.active$X110m.hurdle)
