...
```{r democovid}
library(tidyverse)
#paquete para dibujar distribuciones de puntos -> reemplazo de geom_jitter
library(ggbeeswarm)
...
#df %>% ggplot(aes(x=Region,y=Ct,color=Sex, group=Region)) + geom_quasirandom() +theme_classic()
